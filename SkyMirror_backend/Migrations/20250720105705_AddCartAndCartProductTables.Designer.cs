...
namespace SkyMirror.Migrations
{
    ...
    [Migration("20250720105705_AddCartAndCartProductTables")]
    partial class AddCartAndCartProductTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkyMirror_backend.Entities.Cart", b =>
                {
            ...
            modelBuilder.Entity("SkyMirror_backend.Entities.CartProduct", b =>
                {
                    b.Property<int>("CartId")
                        .HasColumnType("int")
                        .HasColumnName("cartId");
            ...
            modelBuilder.Entity("SkyMirror_backend.Entities.Cart", b =>
                {
                    b.HasOne("SkyMirror.Entities.User", "User")
                        .WithOne("Cart")
                        .HasForeignKey("SkyMirror_backend.Entities.Cart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SkyMirror_backend.Entities.CartProduct", b =>
                {
                    b.HasOne("SkyMirror_backend.Entities.Cart", "Cart")
